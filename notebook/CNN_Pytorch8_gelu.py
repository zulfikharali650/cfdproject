...
config1 = {
    "model": {
        "batch_size": 64,
        "dropout": 0.0,
        "path": "/bigdata/wonglab/syang159/CFD2/pytorch_particle_random_order/" + "SSSSS",
        "path_result": "/bigdata/wonglab/syang159/CFD2/pytorch_particle_random_order/" + "HHHHH" + "/Result_CNN"
    },
    "training": {
        "device": "cuda", # "cuda" or "cpu"
        "batch_size": 64,
        "training_h5_file": "/bigdata/wonglab/syang159/CFD2/Kfold_data/GPT_to_CNN/training_data_from_GPT_EEEEE.hdf5",
        "block_size": 50,
        "ndata": 2500,  #2500
        "num_epoch": 300, #100
        "learning_rate": 0.001,
    ...
    "validating": {
        "validating_h5_file": "/bigdata/wonglab/syang159/CFD2/Kfold_data/GPT_to_CNN/validating_data_from_GPT_EEEEE.hdf5",
        "batch_size": 16,
        "block_size": 50,
        "stride": 3000,
        "ndata": 312,  #312
    ...
    "testing": {
        "testing_h5_file": "/bigdata/wonglab/syang159/CFD2/Kfold_data/GPT_to_CNN/testing_data_from_GPT.hdf5",
        "batch_size": 16,
        "block_size": 50,
        "stride": 3000,
        "ndata": 313  #313
...
config2 = {
    ...
    "training": {
        "device": "cuda", # "cuda" or "cpu"
        "batch_size": 64,
        "training_h5_file": "/bigdata/wonglab/syang159/CFD2/Kfold_data/LSTM_to_CNN/training_data_from_LSTM_EEEEE.hdf5",
        "block_size": 50,
        "ndata": 2500,  #2500
        "num_epoch": 300, #100
        "learning_rate": 0.001,
    ...
    "validating": {
        "validating_h5_file": "/bigdata/wonglab/syang159/CFD2/Kfold_data/LSTM_to_CNN/validating_data_from_LSTM_EEEEE.hdf5",
        "batch_size": 16,
        "block_size": 50,
        "stride": 3000,
        "ndata": 312,  #312
    ...
    "testing": {
        "testing_h5_file": "/bigdata/wonglab/syang159/CFD2/Kfold_data/LSTM_to_CNN/testing_data_from_LSTM.hdf5",
        "batch_size": 16,
        "block_size": 50,
        "stride": 3000,
        "ndata": 313  #313
...
training_index, testing_index= train_test_split(index, test_size=0.1, random_state=25)
#testing_index[0:36]
...
os.chdir(path + '/level_7/original')
df_2 = pd.read_csv("erosion_denominator2.csv" ,header=None)
...
for k in range(0, out.size(0), 10):
    ...
    plt.savefig('plot_%i_predicted_ero.png'%k)
    ...
    ax2.plot_surface(Xm,Zm,Ym,alpha=0.1,color='blue')
    ax2.plot_surface(Xi1,Zi1,Yi1,alpha=0.1,color='blue')
    ax2.plot_surface(Xi2,Zi2,Yi2,alpha=0.1,color='blue')
    ax2.plot_surface(Xi3,Zi3,Yi3,alpha=0.1,color='blue')
    # ax.xaxis.set_major_locator(plt.MaxNLocator(5))
    # ax.yaxis.set_major_locator(plt.MaxNLocator(5))
    # ax.zaxis.set_major_locator(plt.MaxNLocator(5))
    ...
    ax2.scatter(X,Z,Y, s = 1000000*W, c=scalarMap.to_rgba(W), label='Erosion profile')
    ...
    ax2.axes.set_xlim3d(left=-0.8, right=0.8)
    ax2.axes.set_ylim3d(bottom=-0.8, top=0.8)
    ax2.axes.set_zlim3d(bottom=-0.8, top=0.8)
    # plt.grid()
    ...
    os.chdir(config["model"]["path"] + '/plot/')
    plt.savefig('plot_%i_original_ero.png'%k)

                 
#print("Average_r2_score: %.5f (+/- %.5f)" % (np.mean(r2), np.std(r2)))

#print("Average_rmse: %.5f (+/- %.5f)" % (np.mean(mse), np.std(mse)))
